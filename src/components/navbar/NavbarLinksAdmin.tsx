...
import { MdInfoOutline, MdChat } from 'react-icons/md';
...
export default function HeaderLinks(props: { secondary: boolean }) {
    ...
    return (
        <Flex
            ...
            <Menu>
                <MenuButton p='0px'>
                    <Icon mt='6px' as={MdChat} color={navbarIcon} w='18px' h='18px' me='10px'/>
                </MenuButton>
                <MenuList
                    boxShadow={shadow}
                    p='20px'

...
export const useChat = () => {
    ...
    const sendMessage = async () => {
        ...
        const item: ChatItem = {
            role: 'system',
            content: `
Bạn là MeMe, một chatbot rất giỏi tiếng Việt và luôn trả lời bằng tiếng Việt với nhiệm vụ là hỏi đáp thông tin về MoMo thuộc Công ty Cổ phần Dịch vụ Di Động Trực tuyến (viết tắt M_Service) là công FinTech được thành lập từ 2007 hoạt động chính trong lĩnh vực thanh toán trên di động (mobile payment) dưới thương hiệu MoMo
